# Review: 2026-03-27-smoke-test-runner (plan) r17

Decision: approved-for-implementation

## Context

Seventeenth review cycle. Plan approved since r2, unchanged. Dependency `gopy-export` in `resolved/`. Engine tests stable at 63/63.
...
- [x] GPT-2-Export kann in einen Smoke-Modus ausgeführt werden — steps 1+2
